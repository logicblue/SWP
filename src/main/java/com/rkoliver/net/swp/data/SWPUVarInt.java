...
public class SWPUVarInt extends SWPData {
	
	public static final int MAX_1_BYTE_VALUE = 127;
	public static final int MAX_2_BYTE_VALUE = 16383;
	public static final int MAX_3_BYTE_VALUE = 2097151;
	public static final int MAX_4_BYTE_VALUE = 268435455;
	public static final long MAX_5_BYTE_VALUE = 34359738367L;
	public static final long MAX_6_BYTE_VALUE = 4398046511103L;
	public static final long MAX_7_BYTE_VALUE = 562949953421311L;
	public static final long MAX_8_BYTE_VALUE = 72057594037927935L;
	...
	public SWPUVarInt(int i) throws SWPException {
	...
	public SWPUVarInt(long l) throws SWPException { 
	...
	public SWPUVarInt(byte[] bytes, int offset, int length) throws SWPException {
	
		value = decodeLong(bytes, offset, length);
	}
	
	public SWPUVarInt(byte[] bytes, int offset) throws SWPException {
		
		value = decodeLong(bytes, offset, null);
	}
	
	public SWPUVarInt() throws SWPException {
	...
	public static int decodeInt(byte[] bytes, int offset, int[] outLength) throws SWPException {
		...
		outLength[0] = decodeVarIntLength(bytes[offset]);
	...
	public static long decodeLong(byte[] bytes, int offset, int length) throws SWPException {
		...
		int decodedLength = decodeVarIntLength(b0);
	...
	private static int decodeVarIntLength(byte b0) throws SWPException {
	...
	public static int getMinimumLength(long l) {
		...
		if (l <= MAX_1_BYTE_VALUE) {
			
			return 1;
		}
		
		if (l <= MAX_2_BYTE_VALUE) {
			
			return 2;
		}
		
		if (l <= MAX_3_BYTE_VALUE) {
			
			return 3;
		}
		
		if (l <= MAX_4_BYTE_VALUE) {
			
			return 4;
		}

		if (l <= MAX_5_BYTE_VALUE) {
			
			return 5;		
		}
		
		if (l <= MAX_6_BYTE_VALUE) {
			
			return 6;
		}
		
		if (l <= MAX_7_BYTE_VALUE) {
			
			return 7;
		}
		
		if (l <= MAX_8_BYTE_VALUE) {
